...
data_list = [{'error': '', 'vi_result': '{"__type__": "DictData", "cls_name": "VIResult", "value": {"error": "", "defects": [{"class": "yinlie", "prob": 0.8296175599098206, "loc": [3, 9], "coord": [2558, 1838, 2839, 1854]}], "is_ng": false, "ext_info": {}}}'}]
