...
data_list = [
    {
        "error": "",
        "vi_result": '{"__type__": "DictData", "cls_name": "VIResult", "value": {"error": "", "defects": [{"class": "yinlie", "prob": 0.999, "loc": [1, 1], "coord": [100, 120, 200, 220]}], "is_ng": false, "ext_info": {}}}',
    }
]
...
def return_data(request):
    ...
    data_list.append(
        {
            "error": "",
            "vi_result": '{"__type__": "DictData", "cls_name": "VIResult", "value": {"error": "", "defects": [{"class": "xuhan", "prob": 0.999, "loc": [2, 1], "coord": [400, 200, 500, 300]}], "is_ng": false, "ext_info": {}}}',
        }
    )
